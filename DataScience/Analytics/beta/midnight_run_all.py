...
from check_performance_ivy import main as check_performance
#from param_search import DEFAULT_CONFIG
...
new_folder_name =  time.strftime("%B_%d_") +  uri_version  + '_new_AB'     # change the explanatory name !
#new_folder_name = 'April_28_branch_locality_etc'
wait_hours = 5                  # wait 5 hours before firing the queries 
